...
public class RegistroAlumnos extends javax.swing.JFrame {
    ...
    public RegistroAlumnos() {
        initComponents();
        this.setLocationRelativeTo(null); //Centra la interfaz cada vez que el programa se ejecuta
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/bd_test" , "root" , "root");
            PreparedStatement pst = cn.prepareStatement("insert into alumnos values (?,?,?)");
            pst.setString(1, "O");
            pst.setString(2, txt_nombre.getText().trim());
            pst.setString(3, txt_grupo.getText().trim());
            pst.executeUpdate();    // Permite ejecutar las instrucciones que le estamos enviando a las bases de datos
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            ResultSet rs = pst.executeQuery(); // Nos permite obtener el resultado de esta consulta a nuestra base de datos.
            
            if(rs.next()){
                txt_nombre.setText(rs.getString("NombreAlumno"));
                txt_grupo.setText(rs.getString("Grupo"));
            }else{
                JOptionPane.showInputDialog(null, "Alumno no registrado");
            }
